...
const ButtonSidebar = ({ route, text, icon }: ButtonSidebarType) => {
  return (
    <Link
      href={route}
      className="w-16 hover:bg-cyan-400 mt-5 h-20 rounded-2xl border border-slate-300 flex flex-col justify-evenly items-center"
    >
